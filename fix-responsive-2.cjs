...
replaceInFile("src/components/host/HostVanDetail.tsx", [
  [
    ...
    'className="flex flex-col items-start sm:items-center w-full max-w-4xl mx-auto px-4 mt-6 overflow-hidden"',
  ],
  [
    'className="flex gap-10 mt-3"',
    'className="flex flex-col sm:flex-row gap-6 sm:gap-10 mt-6 sm:items-center"',
  ],
  [
